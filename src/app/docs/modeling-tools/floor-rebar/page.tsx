...
export default function FloorRebarPage() {
  return (
      ...
      <div className="mx-auto w-full max-w-6xl px-4 md:px-6 py-8 md:py-10 space-y-10">
        ...
        <header className="space-y-3">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight leading-tight">
            Floor Rebar — User Guide
          </h1>
          <p className="text-base text-muted-foreground">
            คู่มือการใช้งานคำสั่ง Floor Rebar คำสั่งสำหรับสร้างโมเดลเหล็กเสริมพื้นอย่างรวดเร็ว
          </p>
        </header>
        <Separator />
        ...
        <section className="text-center space-y-6">
          <div className="max-w-8xl mx-auto rounded-xl overflow-hidden shadow-lg aspect-video">
            <iframe
              ...
              src="https://www.youtube.com/embed/76yaRN2VWqA?si=9tTsZdDgXoGaazbV"
