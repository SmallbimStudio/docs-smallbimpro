  ...
  return (
    <SidebarInset>
      <div className="mx-auto max-w-6xl px-4 md:px-6 py-8 md:py-10 space-y-8">
        <header className="space-y-2"><h1 className="text-3xl md:text-4xl font-bold">Ceiling Tag (Plan)</h1><p className="text-sm md:text-base text-muted-foreground">แท็กฝ้าเพดาน</p></header>
        <Separator />
