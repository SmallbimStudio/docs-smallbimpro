...
export const NAV: NavCategory[] = [
...

  {
    ...
    url: "#",
    items: [
      { title: "Land Rescaler", href: "/docs/modeling-tools/land-rescaler" },
      ...
      { title: "Column Footing Rebar", href: "/docs/modeling-tools/column-footing-rebar" },
      { title: "Column Rebar", href: "/docs/modeling-tools/column-rebar" },
      { title: "Beam Rebar", href: "/docs/modeling-tools/beam-rebar" },
      { title: "Floor Rebar", href: "/docs/modeling-tools/floor-rebar" },
      { title: "Stair Rebar", href: "/docs/modeling-tools/stair-rebar" },
      { title: "Roof Framing", href: "/docs/modeling-tools/roof-framing" },
      { title: "Floor Tiles Generator", href: "/docs/modeling-tools/floor-tiles-generator" },
      { title: "Room to Elements", href: "/docs/modeling-tools/room-to-elements" },
      { title: "Conduit Generator", href: "/docs/modeling-tools/conduit-generator" },  
